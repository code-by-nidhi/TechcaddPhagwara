...
// Optional-chained because `import.meta.env` only exists under Vite. Without
// it this module cannot be imported by a plain node script, which makes the
// schemas that transitively depend on it untestable outside a browser build.
