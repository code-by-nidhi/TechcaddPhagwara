  ...
  return (
    ...
    >
      ...
      <DropdownItem
        ...
        tone="danger"
        onSelect={async () => {
          const reachedServer = await logout()

          if (reachedServer) {
            toast.success('Signed out.')
          } else {
            // Said plainly rather than swallowed: this browser is signed out,
            // but the session on the server may still be open, and on a shared
            // machine that is worth knowing.
