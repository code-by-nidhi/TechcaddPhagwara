          ...
          <Card flush>
            ...
            <CardBody className="space-y-5">
              ...
              <FormField
                label="Category"
                required
                description="Where this question appears on the FAQ page. Type a new heading to create it."
                error={errors.categoryName?.message}
              >
                {/*
                  Pick an existing heading, or type a new one.

                  A plain select cannot make the first category, and there is
                  no separate category screen any more. The list is offered so
                  the existing spelling is the easy choice — the API matches on
                  a slug, so "Placements" typed again finds the row rather than
                  making a second one.
                */}
                <Input
